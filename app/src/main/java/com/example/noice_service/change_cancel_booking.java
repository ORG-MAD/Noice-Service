...
public class change_cancel_booking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.change_cancel_form);
...
//create a list of items for the spinner.
        String[] items = new String[]{"10:00 AM", "12:00 PM", "01:00 PM"};
