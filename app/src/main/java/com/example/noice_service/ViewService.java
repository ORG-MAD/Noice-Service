    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(ViewService.this,UpdateService.class);
    ...
    private void CreateAlertDialoge() {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int which) {
                Toast.makeText(ViewService.this, "Yes Button is Pressed", Toast.LENGTH_SHORT).show();
            }
        });
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int which) {
                Toast.makeText(ViewService.this, "No Button is Pressed", Toast.LENGTH_SHORT).show();
            }
        });
        builder.create();
        builder.show();
